...
<Box style={{margin:"auto",textAlign:"justify",}}>
  <OrderedList  spacing={4} style={{rowGap:"10px"}}>
    <ListItem>Each turn, click between two horizontally or vertically adjacent dots to draw a line/wall.</ListItem>
...
<Box className='divider'>
  <Box >
    ...
    <Text>BARS AND SQUARES ɪꜱ ᴀ ꜰᴜɴ ᴀɴᴅ ꜱɪᴍᴘʟᴇ ᴄʟᴀꜱꜱɪᴄ ᴘᴇɴ-ᴀɴᴅ-ᴘᴀᴘᴇʀ ɢᴀᴍᴇ ꜰᴏʀ 2 ᴏʀ ᴍᴏʀᴇ ᴘʟᴀʏᴇʀꜱ. ᴛʜᴇ ɢᴀᴍᴇ ꜱᴛᴀʀᴛꜱ ᴡɪᴛʜ ᴀɴ ᴇᴍᴘᴛʏ ɢʀɪᴅ ᴏꜰ ᴅᴏᴛꜱ. ᴛʜᴇ ɢʀɪᴅ ᴄᴀɴ ʙᴇ ᴀɴʏ ꜱɪᴢᴇ ᴀɴᴅ ɢᴀᴍᴇᴛᴀʙʟᴇ'ꜱ BARS AND SQUARES ʜᴀꜱ ᴀ ʜᴀɴᴅꜰᴜʟ ᴛᴏ ᴄʜᴏᴏꜱᴇ ꜰʀᴏᴍ.</Text>
