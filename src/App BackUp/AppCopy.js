...
useEffect(()=>{
  ...
  for(let i=0;i<row*col+col;i++){
    horizontal.push({key:i,type:'horizontal',isClicked:false,btncolor:"lightgrey",disabled:false,active:false})
  }
  for(let i=0;i<row*col+row;i++){
    vertical.push({key:i,type:'vertical',isClicked:false,btncolor:"lightgrey",disabled:false,active:false})
  }
